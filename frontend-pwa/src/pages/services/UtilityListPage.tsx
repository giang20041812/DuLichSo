      ...
      <section className="relative w-full min-h-[420px] md:min-h-[380px] flex items-start md:items-center justify-center pt-[175px] md:pt-[160px] pb-10 md:pb-8">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 bg-white/20 text-white backdrop-blur-md mb-3 px-3.5 py-1.5 rounded-md text-xs font-semibold shadow-sm border border-white/20">
            ...
            <span>Tiện ích đồng hành & Dịch vụ địa phương Mù Cang Chải</span>
          </div>
      ...
      <div className="max-w-[1280px] mx-auto w-full px-4 md:px-8 pt-3 pb-8">
        ...
        <div className="flex items-center gap-2 mb-4 p-1.5 bg-white border border-gray-200 rounded-lg shadow-2xs max-w-md">
          <button
            ...
            className={`flex-1 py-2 px-3 text-xs md:text-sm font-bold rounded-md transition-all ${
              activeTab === 'ALL'
          ...
          <button
            ...
            className={`flex-1 py-2 px-3 text-xs md:text-sm font-bold rounded-md flex items-center justify-center gap-1.5 transition-all ${
              activeTab === 'PHOTO'
                ? 'bg-[var(--color-primary)] text-white shadow-xs'
                : 'text-gray-600 hover:text-[var(--color-primary)]'
            }`}
                    ...
                    {[...Array(totalPages)].map((_, i) => (
                      <button 
                        ...
                        className={`w-10 h-10 rounded-full font-medium text-sm transition-colors ${
                          currentPage === i + 1 ? 'bg-[var(--color-primary)] text-white shadow-sm' : 'text-[var(--color-ink-deep)] bg-white hover:bg-gray-100'
                        }`}
                      >
                        {i + 1}
                      </button>
